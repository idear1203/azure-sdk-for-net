...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class LibraryClient
    {
        ...
        public virtual async Task<LibraryCreateOrAppendOperation> StartCreateOrAppendAsync(string libraryName, Stream content, string comp = null, long? xMsBlobConditionAppendpos = null, CancellationToken cancellationToken = default)
        {
            if (libraryName == null)
            {
                throw new ArgumentNullException(nameof(libraryName));
            ...
            try
            {
                var originalResponse = await RestClient.CreateOrAppendAsync(libraryName, content, comp, xMsBlobConditionAppendpos, cancellationToken).ConfigureAwait(false);
                return new LibraryCreateOrAppendOperation(_clientDiagnostics, _pipeline, RestClient.CreateCreateOrAppendRequest(libraryName, content, comp, xMsBlobConditionAppendpos).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="libraryName"/> or <paramref name="content"/> is null. </exception>
        public virtual LibraryCreateOrAppendOperation StartCreateOrAppend(string libraryName, Stream content, string comp = null, long? xMsBlobConditionAppendpos = null, CancellationToken cancellationToken = default)
        {
            if (libraryName == null)
            {
                throw new ArgumentNullException(nameof(libraryName));
            ...
            try
            {
                var originalResponse = RestClient.CreateOrAppend(libraryName, content, comp, xMsBlobConditionAppendpos, cancellationToken);
                return new LibraryCreateOrAppendOperation(_clientDiagnostics, _pipeline, RestClient.CreateCreateOrAppendRequest(libraryName, content, comp, xMsBlobConditionAppendpos).Request, originalResponse);
            }
            catch (Exception e)
            {
