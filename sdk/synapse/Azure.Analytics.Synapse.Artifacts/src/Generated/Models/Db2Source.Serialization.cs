...
{
    public partial class Db2Source : IUtf8JsonSerializable
    {
        ...
        internal static Db2Source DeserializeDb2Source(JsonElement element)
        {
            ...
            return new Db2Source(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
