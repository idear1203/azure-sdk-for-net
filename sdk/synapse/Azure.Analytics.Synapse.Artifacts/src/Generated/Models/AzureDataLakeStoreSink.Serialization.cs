...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureDataLakeStoreSink : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (EnableAdlsSingleFileParallel != null)
            {
        ...
        internal static AzureDataLakeStoreSink DeserializeAzureDataLakeStoreSink(JsonElement element)
        {
            ...
            object enableAdlsSingleFileParallel = default;
            string type = default;
            ...
            return new AzureDataLakeStoreSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, copyBehavior, enableAdlsSingleFileParallel);
        }
    }
}
