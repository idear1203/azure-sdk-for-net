...
{
    public partial class ZohoSource : IUtf8JsonSerializable
    {
        ...
        internal static ZohoSource DeserializeZohoSource(JsonElement element)
        {
            ...
            return new ZohoSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
