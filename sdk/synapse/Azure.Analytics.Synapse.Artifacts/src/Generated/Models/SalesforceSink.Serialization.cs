...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SalesforceSink : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceSink DeserializeSalesforceSink(JsonElement element)
        {
            ...
            return new SalesforceSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, writeBehavior, externalIdFieldName, ignoreNullValues);
        }
    }
}
