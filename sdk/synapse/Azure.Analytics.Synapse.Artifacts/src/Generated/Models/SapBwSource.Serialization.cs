...
{
    public partial class SapBwSource : IUtf8JsonSerializable
    {
        ...
        internal static SapBwSource DeserializeSapBwSource(JsonElement element)
        {
            ...
            return new SapBwSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
