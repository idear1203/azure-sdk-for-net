...
{
    public partial class FileSystemSink : IUtf8JsonSerializable
    {
        ...
        internal static FileSystemSink DeserializeFileSystemSink(JsonElement element)
        {
            ...
            return new FileSystemSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, copyBehavior);
        }
    }
}
