...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SqlSink : IUtf8JsonSerializable
    {
        ...
        internal static SqlSink DeserializeSqlSink(JsonElement element)
        {
            ...
            return new SqlSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, sqlWriterStoredProcedureName, sqlWriterTableType, preCopyScript, storedProcedureParameters, storedProcedureTableTypeParameterName, tableOption);
        }
    }
}
