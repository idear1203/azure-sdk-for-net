...
{
    public partial class AzureMySqlSink : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlSink DeserializeAzureMySqlSink(JsonElement element)
        {
            ...
            return new AzureMySqlSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, preCopyScript);
        }
    }
}
