...
{
    public partial class AzurePostgreSqlSink : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlSink DeserializeAzurePostgreSqlSink(JsonElement element)
        {
            ...
            return new AzurePostgreSqlSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, preCopyScript);
        }
    }
}
