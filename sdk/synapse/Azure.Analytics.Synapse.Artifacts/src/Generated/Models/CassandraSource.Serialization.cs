...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class CassandraSource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("consistencyLevel");
        ...
        internal static CassandraSource DeserializeCassandraSource(JsonElement element)
        {
            ...
            CassandraSourceReadConsistencyLevels? consistencyLevel = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("consistencyLevel"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new CassandraSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query, consistencyLevel);
        }
    }
}
