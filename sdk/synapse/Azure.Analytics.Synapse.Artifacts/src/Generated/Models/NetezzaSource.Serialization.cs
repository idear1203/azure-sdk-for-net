...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class NetezzaSource : IUtf8JsonSerializable
    {
        ...
        internal static NetezzaSource DeserializeNetezzaSource(JsonElement element)
        {
            ...
            NetezzaPartitionOption? partitionOption = default;
            NetezzaPartitionSettings partitionSettings = default;
            ...
            return new NetezzaSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query, partitionOption, partitionSettings);
        }
    }
}
