...
{
    public partial class SqlServerSource : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerSource DeserializeSqlServerSource(JsonElement element)
        {
            ...
            return new SqlServerSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, sqlReaderQuery, sqlReaderStoredProcedureName, storedProcedureParameters, produceAdditionalTypes);
        }
    }
}
