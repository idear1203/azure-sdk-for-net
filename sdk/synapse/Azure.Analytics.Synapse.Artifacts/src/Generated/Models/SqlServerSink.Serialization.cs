...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SqlServerSink : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerSink DeserializeSqlServerSink(JsonElement element)
        {
            ...
            return new SqlServerSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, sqlWriterStoredProcedureName, sqlWriterTableType, preCopyScript, storedProcedureParameters, storedProcedureTableTypeParameterName, tableOption);
        }
    }
}
