...
{
    public partial class CosmosDbMongoDbApiSink : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDbMongoDbApiSink DeserializeCosmosDbMongoDbApiSink(JsonElement element)
        {
            ...
            return new CosmosDbMongoDbApiSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, writeBehavior);
        }
    }
}
