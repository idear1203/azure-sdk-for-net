...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class SalesforceServiceCloudSink : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceServiceCloudSink DeserializeSalesforceServiceCloudSink(JsonElement element)
        {
            ...
            return new SalesforceServiceCloudSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, writeBehavior, externalIdFieldName, ignoreNullValues);
        }
    }
}
