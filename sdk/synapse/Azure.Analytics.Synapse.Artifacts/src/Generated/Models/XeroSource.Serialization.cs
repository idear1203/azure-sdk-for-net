...
{
    public partial class XeroSource : IUtf8JsonSerializable
    {
        ...
        internal static XeroSource DeserializeXeroSource(JsonElement element)
        {
            ...
            return new XeroSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
