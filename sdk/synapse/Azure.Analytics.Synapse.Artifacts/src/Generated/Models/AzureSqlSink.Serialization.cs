...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AzureSqlSink : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlSink DeserializeAzureSqlSink(JsonElement element)
        {
            ...
            return new AzureSqlSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, sqlWriterStoredProcedureName, sqlWriterTableType, preCopyScript, storedProcedureParameters, storedProcedureTableTypeParameterName, tableOption);
        }
    }
}
