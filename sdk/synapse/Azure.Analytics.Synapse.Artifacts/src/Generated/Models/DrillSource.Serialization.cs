...
{
    public partial class DrillSource : IUtf8JsonSerializable
    {
        ...
        internal static DrillSource DeserializeDrillSource(JsonElement element)
        {
            ...
            return new DrillSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
