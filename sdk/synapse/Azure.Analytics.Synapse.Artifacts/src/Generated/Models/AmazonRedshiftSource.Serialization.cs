...
namespace Azure.Analytics.Synapse.Artifacts.Models
{
    public partial class AmazonRedshiftSource : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("redshiftUnloadSettings");
        ...
        internal static AmazonRedshiftSource DeserializeAmazonRedshiftSource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("redshiftUnloadSettings"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new AmazonRedshiftSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query, redshiftUnloadSettings);
        }
    }
}
