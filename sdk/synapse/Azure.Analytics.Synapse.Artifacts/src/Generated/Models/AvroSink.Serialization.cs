...
{
    public partial class AvroSink : IUtf8JsonSerializable
    {
        ...
        internal static AvroSink DeserializeAvroSink(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("formatSettings"))
                {
                    ...
                    formatSettings = AvroWriteSettings.DeserializeAvroWriteSettings(property.Value);
                    continue;
                }
            ...
            return new AvroSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties, storeSettings, formatSettings);
        }
    }
}
