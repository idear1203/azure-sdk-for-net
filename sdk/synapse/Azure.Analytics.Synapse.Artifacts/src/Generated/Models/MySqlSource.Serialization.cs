...
{
    public partial class MySqlSource : IUtf8JsonSerializable
    {
        ...
        internal static MySqlSource DeserializeMySqlSource(JsonElement element)
        {
            ...
            return new MySqlSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
