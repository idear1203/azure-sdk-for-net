...
{
    public partial class HiveSource : IUtf8JsonSerializable
    {
        ...
        internal static HiveSource DeserializeHiveSource(JsonElement element)
        {
            ...
            return new HiveSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
