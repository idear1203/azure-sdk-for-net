...
{
    public partial class JiraSource : IUtf8JsonSerializable
    {
        ...
        internal static JiraSource DeserializeJiraSource(JsonElement element)
        {
            ...
            return new JiraSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query);
        }
    }
}
