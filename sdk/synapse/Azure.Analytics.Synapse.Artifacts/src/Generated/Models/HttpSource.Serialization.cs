...
{
    public partial class HttpSource : IUtf8JsonSerializable
    {
        ...
        internal static HttpSource DeserializeHttpSource(JsonElement element)
        {
            ...
            return new HttpSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, httpRequestTimeout);
        }
    }
}
