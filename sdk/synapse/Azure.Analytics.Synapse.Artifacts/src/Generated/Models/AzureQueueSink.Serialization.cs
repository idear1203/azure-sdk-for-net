...
{
    public partial class AzureQueueSink : IUtf8JsonSerializable
    {
        ...
        internal static AzureQueueSink DeserializeAzureQueueSink(JsonElement element)
        {
            ...
            return new AzureQueueSink(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, additionalProperties);
        }
    }
}
