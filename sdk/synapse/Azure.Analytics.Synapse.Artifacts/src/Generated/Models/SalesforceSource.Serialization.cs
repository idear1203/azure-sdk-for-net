...
{
    public partial class SalesforceSource : IUtf8JsonSerializable
    {
        ...
        internal static SalesforceSource DeserializeSalesforceSource(JsonElement element)
        {
            object query = default;
            SalesforceSourceReadBehavior? readBehavior = default;
            ...
            return new SalesforceSource(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, additionalProperties, queryTimeout, query, readBehavior);
        }
    }
}
